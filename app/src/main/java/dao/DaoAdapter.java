...
//DaoAdapter É O RESPOSAVEL POR MONTAR O BANCO (CRIAR TABELAS)
//INSERIR, DELETAR E ATUALIZAR DADOS VINDO DO DaoUsuarios
public class DaoAdapter extends SQLiteOpenHelper {
    ...
    public long queryInsertLastId(String table, ContentValues values){
         ...
         * values => valores da tabela (nome, senha, rg...)
         */
        long status = -1;
        try {
